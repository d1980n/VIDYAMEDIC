...
// Set kode suster otomatis ketika komponen pertama kali dimuat
useEffect(() => {
  setSuster(prevState => ({
    ...prevState,
    kode_sus: generateKodeSuster()
  }));
}, []);
        ...
        <div className="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
          ...
          <div className="body-wrapper">
            ...
            <div className="container-fluid">
              ...
              <div>
                <button className="btn btn-primary mb-3" onClick={toggleModal}>Tambah Suster</button>
                <div className="row">
                          ...
                          <table className="table text-nowrap mb-0 align-middle">
                            <thead className="text-dark fs-4">
                              <tr>
                                ...
                                <th className="border-bottom-0">
                                  <h6 className="fw-semibold mb-0">Nama Suster</h6>
                                </th>
                                <th className="border-bottom-0">
